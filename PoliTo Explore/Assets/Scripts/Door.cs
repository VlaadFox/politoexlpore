...
public class Door : MonoBehaviour
{
    ...
    private void Start()
    {
        _originalRotation = _doorHinge.transform.localRotation;
    }
    ...
    private IEnumerator AnimateDoor(Quaternion targetRotation, float animationTime)
    {
        ...
        Quaternion startRotation = _doorHinge.transform.localRotation;
         
        while (animationTimer < animationTime)
        {
            animationTimer += Time.deltaTime;
            _doorHinge.transform.localRotation = Quaternion.Lerp(startRotation, targetRotation, animationTimer / animationTime);
            yield return null;
        }
